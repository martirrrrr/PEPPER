...
def play_music_and_dance(audio_service, motion_service, music_file, dance_moves):
    # Riproduce la canzone in un thread separato
    def play_music():
...
def main():
    ...
    # Definisce i movimenti di danza
    dance_moves = [
    ...
    # Riproduce la prima canzone e balla
    play_music_and_dance(audio_service, motion_service, "/home/nao/music/song1.mp3", dance_moves)
    ...
    def on_speech_recognized(value):
        if value in vocabulary:
            if value == "sì":
                ...
                play_music_and_dance(audio_service, motion_service, "/home/nao/music/song2.mp3", dance_moves)
